...
public class BorrowRecord implements Serializable {
    ...
    @Generated
    public BorrowRecord(Long id, Boolean isFlag, String passage, String card, Boolean borrow, Boolean result, String time, String keepone, String keeptwo, String keepthree) {
        this.id = id;
        this.isFlag = isFlag;
