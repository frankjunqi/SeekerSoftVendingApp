...
public class Passage implements Serializable {
    ...
    @Generated
    public Passage(Integer capacity, Boolean isDel, String seqNo, String used, String product, Boolean borrowState, Integer stock, Boolean isSend, String flag, Integer whorlSize, String borrowUser, String objectId, java.util.Date createdAt, java.util.Date updatedAt, String keepone, String keeptwo, String keepthree) {
