...
public class EmpCard implements Serializable {
    ...
    @Generated
    public EmpCard(String card, String emp, Boolean isDel, java.util.Date createdAt, java.util.Date updatedAt, String objectId, String keepone, String keeptwo, String keepthree) {
        this.card = card;
        this.emp = emp;
        this.isDel = isDel;
