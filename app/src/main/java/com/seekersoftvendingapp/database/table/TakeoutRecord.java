...
public class TakeoutRecord implements Serializable {
    ...
    @Generated
    public TakeoutRecord(Long id, Boolean isDel, String passage, String card, String productId, java.util.Date time, String keepone, String keeptwo, String keepthree) {
        this.id = id;
        this.isDel = isDel;
