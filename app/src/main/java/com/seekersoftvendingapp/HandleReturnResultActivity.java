...
public class HandleReturnResultActivity extends BaseActivity {
    ...
    private void backComplete(String cardNo) {
        ...
        Call<SrvResult<Boolean>> mRoadAction = service.backComplete(cardNo, SeekerSoftConstant.machine, passage.getCabNo(), passage.getRoadCode(), 1);
        ...
        mRoadAction.enqueue(new Callback<SrvResult<Boolean>>() {
            ...
            public void onResponse(Call<SrvResult<Boolean>> call, final Response<SrvResult<Boolean>> response) {
                if (response != null && response.body() != null && response.body().getData()) {
                    ...
                    Toast.makeText(HandleReturnResultActivity.this, "提示：此卡无权取货。", Toast.LENGTH_LONG).show();
                }
                hideProgress();
            }
            ...
            public void onFailure(Call<SrvResult<Boolean>> call, Throwable throwable) {
                ...
                Toast.makeText(HandleReturnResultActivity.this, "提示：网络异常。", Toast.LENGTH_LONG).show();
            }
        });
    }
